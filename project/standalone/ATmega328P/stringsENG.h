...
const char beatOpt[] PROGMEM = "BEAT";
...
const char strNoteDivision[] PROGMEM = "Note Division:";
const char strTimeToStop[] PROGMEM = "Time to Stop:";
const char strResetting[] PROGMEM = "Resetting...";
const char strImportEEPROM[] PROGMEM = "Importing EEPROM...";
const char strExportEEPROM[] PROGMEM = "Exporting EEPROM...";